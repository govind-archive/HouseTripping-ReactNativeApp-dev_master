...
const Welcome_challenges = (props) => {
    return (
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={[{
                ...
                <Text style={[{fontSize:28,color:'#000',fontFamily:'BOLD', letterSpacing: -1}]}>Challenges</Text>
            ...
            <View style={[{
              ...
              marginTop:RFValue(10,812)
                ...
                resizeMode="contain"
                source={Images.challenges_win_image} />
            </View>
...
export default Welcome_challenges;