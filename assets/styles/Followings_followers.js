...
export default function Followings_followers({ navigation, route }) {
    ...
    var heading_text = "Following";
    var follow_button = <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'flex-end' }}>
    ...
    if (route.params?.screenName && route.params?.screenName == "follow") {
        follow_button = <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'flex-end' }}>
            <TouchableOpacity style={styles.roundedButtons}>
                <Text>
                    Following
                </Text>
            ...
            >
                ...
                <View style={[styles.customHeader, { height: "7%", width: '100%', flexDirection: 'row' }]}>
                    <TouchableOpacity style={{ marginTop: 5 }}>
                        <Image style={{ width: 20, height: 20, margin: 20, marginLeft: 20, tintColor: '#FFF' }} source={require('../assets/images/back.png')} />
                    </TouchableOpacity>
                ...
                <View style={styles.lower_view}>
                    ...
                    >
                        <View>
                            <Text style={styles.heading_following}>380 followings</Text>
                        </View>
                        <FlatList
