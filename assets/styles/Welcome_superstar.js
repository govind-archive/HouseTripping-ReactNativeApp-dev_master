...
const Welcome_superstar = (props) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ top: "-15%" }}>
                <Text style={styles.heading}>Be a Superstar</Text>
            ...
            {/* <TouchableOpacity style={styles.loginButton}  onPress={() => { props.onParaMeter("Login") }}>
...
export default Welcome_superstar;